...
router.get('/user/:id', passport.authenticate('jwt', { session: false }), bookmarks.getUserBookmarks);
...
router.delete('/', passport.authenticate('jwt', { session: false }), bookmarks.deleteAll);
router.delete('/:id', passport.authenticate('jwt', { session: false }), bookmarks.deleteBookmark);
